...
\begin{frame}
	\frametitle{Centrality of MEPs}
	A different approach to the centrality measure
	
	\pause We analyze the `eigenvector centrality' of each MEP in the social network graph
	
	\vspace{0.3cm}
	
	\pause {\tiny \begin{tabular}{| l | l | r |}
			\hline
			MEP & EP Group & Eigenvector centrality  \\
			\hline
			\worldflag{BE} Hilde Vautmans & RE & 0.1127 \\
			\worldflag{DK} Karen Melchior & RE & 0.1058 \\
			\worldflag{SK} Michal Šimečka & EPP & 0.1031 \\
			\worldflag{BE} Olivier Chastel & RE & 0.0998 \\
			\worldflag{LU} Marc Angel & S\&D & 0.0947 \\
			\worldflag{RO} Ramona Strugariu & RE & 0.0943 \\
			\worldflag{NL} Sophia in 't Veld & RE & 0.0892 \\
			\worldflag{PL} Łukasz Kohut & S\&D & 0.0884 \\
			\worldflag{RO} Nicolae Ștefănuță & RE & 0.0867 \\
			\worldflag{RO} Dragoș Pîslaru & RE & 0.0867 \\
			\hline
	\end{tabular}}
	
	\vspace{0.3cm}
	
	\pause As we can see, we have very similar results to the degree centrality
...
\begin{frame}
	...
	\pause {\tiny \begin{tabular}{| l | l | r |}
			\hline
			MEP & EP Group & Betweenness centrality  \\
			\hline
			\worldflag{IT} Fabio Massimo Castaldo & NI & 0.0131 \\
			\worldflag{RO} Maria Grapini & S\&D & 0.0128 \\
			\worldflag{LT} Petras Auštrevičius & RE & 0.0128 \\
			\worldflag{SE} Charlie Weimers & ECR & 0.0123 \\
			\worldflag{IT} Annalisa Tardino & ID & 0.0117 \\
			\worldflag{PT} Maria da Graça Carvalho & EPP &  0.0116 \\
			\worldflag{NE} Sophia in 't Veld & RE & 0.0109 \\
			\worldflag{DE} Maria Noichl & S\&D & 0.0109 \\
			\worldflag{IT} Luisa Regimenti & ID & 0.0107 \\
			\worldflag{FI} Sirpa Pietikäinen & EPP & 0.0100 \\
			\hline
	\end{tabular}}
